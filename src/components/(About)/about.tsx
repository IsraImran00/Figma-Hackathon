...
const ProductCard: React.FC<ProductCardProps> = ({ image, title, price, index }) => {
  return (
    <div
      key={index}
    ...
    >
      ...
      <div className="flex justify-between w-full px-4 py-2">
        ...
        <div className="flex items-center">
          <FaCartShopping className="w-6 h-6 sm:w-8 sm:h-8 text-teal-500 cursor-pointer transition-transform duration-300 hover:scale-110" />
        </div>
      </div>
    </div>
  );
...
export default function About() {
  const featureImages = [
    { src: '/featuredata/Sofa1.png', title: 'Library Stone Chair', price: '20' },
    { src: '/featuredata/Sofa2.png', title: 'Modern Sofa', price: '25' },
    { src: '/featuredata/Sofa3.png', title: 'Comfy Recliner', price: '35' },
    { src: '/featuredata/Sofa4.png', title: 'Luxury Couch', price: '40' },
  ];
